    ...
    return (
            <PageHeader
                ...
                extra={[
                    ...
                    <Link justify='space-around' key={2} className="headerLink" to="/swipe">Swipe</Link>,
                    // <Link key={3} className="headerLink" to="/profile2">Profile2</Link>,
                    <Link justify='space-around' key={4} className="headerLink" to="/updateprofile">Profile</Link>,
                    <Link justify='space-around' key={5} className="headerLink" to="/matches">Matches</Link>,
